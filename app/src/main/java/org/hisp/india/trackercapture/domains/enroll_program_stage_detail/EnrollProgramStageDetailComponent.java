...
public interface EnrollProgramStageDetailComponent {
    EnrollProgramStageDetailPresenter presenter();

    void inject(EnrollProgramStageDetailActivity enrollProgramStageDetailActivity);
}
